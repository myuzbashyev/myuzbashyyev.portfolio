export default {
  header: {
    "header-logo": "Muhammetaly Ýüzbaşyýew",
    "header-nav": {
      nav_1: "Esasy",
      nav_2: "Men hakda",
      nav_3: "Tehnologiýalar",
      nav_4: "Proýektlar",
      nav_5: "Habarlaşmak",
    },
  },
  home: {
    "home-heading": {
      h_1: "Salam👋, meniň adym",
      h_2: "Men Front-End programist",
    },
  },
  about: {
    "about-heading": "Men hakda",
    "about-paragraph": {
      p_1: "Salam, men 2+ ýyl tejribeli programist",
      p_2: "Arassa kod we häzirki zaman dizaýn ýörelgeleri bilen dolandyrylýan we täsirli web programmalaryny döretmekde ýöriteleşýärin. Maksadym, ajaýyp sanly tejribe döretmek üçin bu tehnologiýalary ulanmak. Taslamalaryňyzy nädip beýgeldip biljekdigimi görmek üçin portfoliom bilen tanyş boluň.",
    },
    "work-experience": {
      heading: "Iş tejribesi",
      profession: "Front-End programist",
      time: "Doly wagt",
      building: "Türkmenistanyň telekommunikasiýalar we informatika instituty",
      city: "Aşgabat",
      month: "Awg",
    },
    education: {
      heading: "Bilim",
      profession: "Kiberhowpsuzlyk inzeneri",
    },
  },
  techStack: {
    heading: "Tehnologiýa toplumym",
    paragraph: "Şu wagt işleýän tehnologiýalarym",
  },
  projects: {
    heading: "Proýektlar",
  ...
  contact: {
    heading: "Islendik sorag üçin maňa e-poçta iberiň",
  },
  footer: {
    p: {
      p_1: "Muhammetaly Ýüzbaşyýew tarapyndan",
      p_2: "we",
      p_3: " ýerleşdirilen serwer",
      p_4: "Tekst",
      p_5: "şriftde ýazylan",
    },
  },
